...
class RuntimeDebugger:
    ...
    def _run_python(code: str) -> Dict[str, str]:
        try:
            ...
            return {
                ...
                "stdout": "",
                "stderr": str(e),
                "hint": "Check Python installation."
            }
    ...
    def _basic_hint(language: str, stderr: str) -> str:
        ...
        if language == "java":
            if "expected" in s:
                return "Missing symbol like ; or )"
            if "cannot find symbol" in s:
                return "Undefined variable/method."
